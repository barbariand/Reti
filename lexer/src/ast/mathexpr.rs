use self::{
    ...
    functions::FunctionCall, integral::Integral, log::Logarithm, matrix::Matrix, number::Number,
    sqrt::Root, sum::Sum, unary_ops::UnaryOp, variable::Variable,
};
...
pub enum MathExpr {
    ...
    FunctionCall(Box<FunctionCall>), // Represents a function call (e.g., sin, cos, exp)
