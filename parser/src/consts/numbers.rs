...
///Limitations of f64 like infinity and max and min
pub mod f64limitation_constants {
    /// Representation of infinity from [f64]
    pub const INFINITY: f64 = f64::INFINITY;
    /// representation of negative infinity from [f64]
    pub const NEG_INFINITYINFINITY: f64 = f64::NEG_INFINITY;
    /// Max representable value from [f64]
    pub const MAX: f64 = f64::MAX;
    /// Min representable value from [f64]
...
/// macro for convertion with fixed ratio
...
///imperial physics constants that are autogenerated
pub mod physics_imperial {
    ///gravitational constants in feet per second squared
    pub mod gravitation {
        use super::super::physics_si::gravitation;
        ///convert from m/s² to f/s²
        pub const MPS2_TO_FPS2: f64 = 3.2808399;

        covert_using_ratio!(MPS2_TO_FPS2, {
            STANDARDDEFINITION=>gravitation::STANDARDDEFINITION,
            EQUATOR=>gravitation::EQUATOR,
            SWEDEN=>gravitation::SWEDEN,
            USA=>gravitation::USA,
            POINT21=>gravitation::POINT78,
            POINT25=>gravitation::POINT79,
            POINT28=>gravitation::POINT80,
            POINT31=>gravitation::POINT81,
            POINT34=>gravitation::POINT82,
            POINT38=>gravitation::POINT83,
            SIMPLE=>gravitation::SIMPLE,
        });
    }
}
